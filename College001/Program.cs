    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var db = new CollegeDBF())
            {
                ...
                ClassMath.Students.Add(scorebook3);

                db.SaveChanges();

                var query = from Class in db.Classes
                            orderby Class.Students
                            select scorebook1;
                ...
                WriteLine($"{Carlton.FName} located at {Carlton.Address}");

                //    foreach (Class Class in  )
                //    {
                //        WriteLine($"- Title: {Class.Title}");
                //        WriteLine($"-- Copies in Department: {Class.Department}");
                //        WriteLine($"-- Copies on Students: {Class.Students}");
                //    }
                //    WriteLine();
                //}
